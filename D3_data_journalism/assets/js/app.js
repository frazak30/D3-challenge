...
// Calculating the chart width and height
...
(async function () {
  ...
  let crlTxtGroup = chartGroup
    .selectAll('mycircles')
    .data(healthData)
    .enter()
    .append('g');

  let circlesGroup = crlTxtGroup
    .append('circle')
...
(async function () {
  ...
  var incomeLabel = xlabelsGroup.append('text').attr('x', 0);
});